        ...
        <tbody>';
                    ...
                    if ($stmt->rowCount() > 0) {
                        while ($row = $stmt->fetch()) {
                            echo '<form action="supprimerAcheter.php" method="post"><tr>
                <td><input type="text" value="'.$row["Gamme_Dove"].'" name="Gamme_Dove" size="10" /></td>
                <td><input type="text" value="'.$row["Creme_de_peau"].'" name="Creme_de_peau" size="10" /></td>
                <td><input type="text" value="'.$row["Sechoir_ENZO_2en1"].'" name="Sechoir_ENZO_2en1" size="10" /></td>
                <td><input type="text" value="'.$row["plaque_ENZO"].'" name="plaque_ENZO" size="10" /></td>
                <td><input type="text" value="'.$row["pack_parfume"].'" name="pack_parfume" size="10" /></td>
                <td><input type="text" value="'.$row["parfume"].'" name="parfume" size="10" /></td>
                <td><input type="text" value="'.$row["LaiTuo"].'" name="pLaiTuo" size="10" /></td>
                <td><input type="text" value="'.$row["tel"].'" name="tel" size="10" /></td>
